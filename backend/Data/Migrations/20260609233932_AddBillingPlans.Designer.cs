...
namespace SocialReviewCard.Data.Migrations
{
    ...
    [Migration("20260609233932_AddBillingPlans")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialReviewCard.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<DateTime?>("FreeExportsPeriodStart")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("FreeExportsUsed")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SocialReviewCard.Models.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SocialReviewCard.Models.BillingPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SocialReviewCard.Models.Feedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SocialReviewCard.Models.Platform", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SocialReviewCard.Models.PlatformSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("FreeExportLimit")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ProFeaturesJson")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("ProPriceLabel")
                        .IsRequired()
                        .HasMaxLength(60)
                        .HasColumnType("character varying(60)");
                    ...
                    b.Property<string>("UpgradeSubtitle")
                        .IsRequired()
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)");

                    b.Property<string>("UpgradeTitle")
                        .IsRequired()
                        .HasMaxLength(200)
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FreeExportLimit = 3,
                            HeadScripts = "",
                            ProFeaturesJson = "[\"Unlimited high-resolution exports\",\"No watermark on your cards\",\"Every premium template & background\"]",
            ...
            modelBuilder.Entity("SocialReviewCard.Models.ReelTheme", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SocialReviewCard.Models.ReviewCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SocialReviewCard.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SocialReviewCard.Models.ReviewCard", b =>
                {
                    b.HasOne("SocialReviewCard.Models.ApplicationUser", "User")
